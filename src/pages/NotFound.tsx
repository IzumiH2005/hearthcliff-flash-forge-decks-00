...
const NotFound = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary/30 to-accent/30 text-white flex flex-col items-center justify-center px-4 py-16 text-center">
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        <Button asChild className="bg-white/20 hover:bg-white/30 backdrop-blur-sm border border-white/10 shadow-lg">
          <Link to="/">
