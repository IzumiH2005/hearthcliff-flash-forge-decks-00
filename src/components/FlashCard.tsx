    ...
    >
      <div className="flashcard-inner w-full h-full relative shadow-lg">
        ...
        >
          ...
          <div className="text-xl font-medium text-center text-primary dark:text-primary-foreground">{front.text}</div>
        ...
        >
          ...
          <div className="text-xl font-medium text-center text-primary dark:text-primary-foreground">{back.text}</div>
